...
public class AvroMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1291259046820824120L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroMessage\",\"namespace\":\"cz.kafka.test\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public AvroMessage(java.lang.Integer id, java.lang.CharSequence name) {
    this.id = id;
    this.name = name;
  }
  ...
  public static Builder newBuilder() {
    return new cz.kafka.test.AvroMessage.Builder();
  }
   ...
   * @return A new AvroMessage RecordBuilder
   */
  public static Builder newBuilder(cz.kafka.test.AvroMessage.Builder other) {
    if (other == null) {
      return new cz.kafka.test.AvroMessage.Builder();
    } else {
      return new cz.kafka.test.AvroMessage.Builder(other);
    }
  }
   ...
   * @return A new AvroMessage RecordBuilder
   */
  public static Builder newBuilder(cz.kafka.test.AvroMessage other) {
    if (other == null) {
      return new cz.kafka.test.AvroMessage.Builder();
    } else {
      return new cz.kafka.test.AvroMessage.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroMessage>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(cz.kafka.test.AvroMessage.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(cz.kafka.test.AvroMessage other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
